...
/// <summary>
/// Reads database-level options and permissions directly from catalog views. Each artifact is a
/// single bulk query (no N+1) and produces deterministic, timestamp-free output: the option script
/// captures settings only (no environment-specific file paths), and the permission script is
/// ordered by its own statement text for stable diffs.
/// </summary>
